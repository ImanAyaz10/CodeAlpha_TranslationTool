  ...
  "cells": [
    {
      ...
      "metadata": {
        ...
        "id": "-ZGbZD2IBOSr",
        "outputId": "85d6bc13-2ab9-4c99-d461-cbebf931bcf4"
      },
      "execution_count": 8,
      "outputs": [
        {
          ...
          "data": {
            "text/plain": [
              "'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'"
            ],
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "mgQin4Dt88aT",
        "outputId": "bcf60bfb-7ba6-4c6c-e8d9-4146966875c1"
      },
      "outputs": [
        {
          "output_type": "stream",
        ...
        },
        {
          ...
          "name": "stderr",
          "text": [
            "/tmp/ipython-input-951648812.py:36: DeprecationWarning: The 'theme' parameter in the Blocks constructor will be removed in Gradio 6.0. You will need to pass 'theme' to Blocks.launch() instead.\n",
        ...
        },
        {
          ...
          "text": [
            ...
            "* Running on public URL: https://dabbb40ce61f5de866.gradio.live\n",
            "\n",
        ...
        },
        {
          ...
          "data": {
            ...
            "text/html": [
              "<div><iframe src=\"https://dabbb40ce61f5de866.gradio.live\" width=\"100%\" height=\"500\" allow=\"autoplay; camera; microphone; clipboard-read; clipboard-write;\" frameborder=\"0\" allowfullscreen></iframe></div>"
            ]
          },
          "metadata": {}
        }
      ...
      "source": [
        ...
        "\n",
        "# 2. Setup Groq Client\n",
        "# Replace \"YOUR_GROQ_API_KEY\" with your actual key if not using env variables\n",
        "client = Groq(api_key=\"tool_key\")\n",
        "\n",
        ...
        "        system_prompt = f\"You are a professional translator. Translate the following text from {source_lang} to {target_lang}. Only provide the translation, no conversational filler.\"\n",
        "\n",
        ...
        "with gr.Blocks(theme=gr.themes.Soft(primary_hue=\"orange\")) as demo:\n",
        "    gr.Markdown(\"# 🌐 Instant AI Translator\")\n",
        "    gr.Markdown(\"Powered by Groq & Llama 3.3 for near-instant results.\")\n",
        "\n",
        "    with gr.Row():\n",
        "        with gr.Column():\n",
        "            input_text = gr.Textbox(label=\"Enter Text\", placeholder=\"Type here...\", lines=5)\n",
        "            source_lang = gr.Dropdown(\n",
        "                choices=[\"English\", \"Spanish\", \"French\", \"German\", \"Chinese\", \"Arabic\", \"Hindi\"],\n",
        "                value=\"English\",\n",
        ...
        "            # This triggers a JavaScript action for the copy button\n",
        "            copy_btn.click(fn=None, inputs=output_text, js=\"(x) => {navigator.clipboard.writeText(x); alert('Copied!');}\")\n",
        "\n",
        "    # Connect the logic\n",
        "    translate_btn.click(\n",
        "        fn=translate_text,\n",
